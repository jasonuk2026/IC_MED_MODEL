...
CUDA_VISIBLE_DEVICES=2,3 torchrun --nproc_per_node=2 train_disease_soft_token_classifier.py   --train_data_dir EHRSHOT_ASSETS/llm_data_v7 --eval_data_paths EHRSHOT_ASSETS/llm_eval_data/*/val.parquet --bert_embeddings data/biolinkbert_embeddings/embeddings.npy --bf16 --batch_size 32 --eval_batch_size 32   --pad_to_num_events 1000   --num_workers 4   --prefetch_factor 8   --lr 2e-4   --warmup_ratio 0.1   --weight_decay 0.005   --grad_clip 1.0   --hidden_size 768   --num_layers 2   --num_heads 4   --head_layers 1   --pos_weight 1.0   --wandb_project medical_cond_embed   --wandb_tags soft_token_classifier --position_type learned --attention_type bidirectional --aux_loss_weight 0.2 --align_loss_weight 0.1

CUDA_VISIBLE_DEVICES=2,3 torchrun --nproc_per_node=2 train_disease_soft_token_classifier.py   --train_data_dir EHRSHOT_ASSETS/llm_data_v7 --eval_data_paths EHRSHOT_ASSETS/llm_eval_data/*/val.parquet --bert_embeddings ./embeddings.npy --bf16 --batch_size 32 --eval_batch_size 32 --pad_to_num_events 1000 --num_workers 4 --prefetch_factor 8 --lr 2e-4 --warmup_ratio 0.1 --weight_decay 0.005 --grad_clip 1.0 --hidden_size 768 --num_layers 2 --num_heads 4 --head_layers 1 --pos_weight 1.0 --wandb_project medical_cond_embed --wandb_tags soft_token_classifier --position_type learned --attention_type bidirectional --aux_loss_weight 0.2 --align_loss_weight 0.1 --train_data_epochs 0 1 2 3
